...
$page = new Page;
	...
	$page->page_name = 'relations';		// page name for menu and other purpose
	...
	$page->class_list = array("class_memberrelationdetail.php", "class_user.php");
    ...
    $page->plugin_path = 'plugins/member_relation/'; 
    $page->plugin = 'relations';
