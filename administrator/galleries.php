...
$page = new Page;
	...
	$page->title = "Rotary: Administrator - Galleries";	// page Title
	...
	$page->class_list = array("class_gallery.php", "class_status.php", "class_pagination.php");
    ...
    $page->plugin_path = 'plugins/gallery/'; 
    $page->plugin = 'list';
