...
<tr>
    ...
    <tr>
     ...
     <tr>
      <td class="caption" ><?php echo $CAP_user ?></td>
    ...
    <tr>
        ...
        <th><?php echo $CAP_user?></th>
        <th><?php echo $CAP_relation ?></th>
    </tr>
     ...
     while ( $count_data_bylimit > $index ){
        $link = "bulletin.php?id=".$data_bylimit[$index]["id"]."";
         if ( $style == "row_lite" ){
            $style="row_dark";
        }
        else{
    ...
    <tr onmouseover="this.className='row_highlight'" onmouseout="this.className='<?php echo $style; ?>'"  class="<?php echo $style; ?>" >
        ...
        <td><?php 
					if(isset($data_bylimit[$index]["user_id"]) && $data_bylimit[$index]["user_id"] > 0){
						$user_id = $data_bylimit[$index]["user_id"];
						echo $array_user [$user_id]["name"];
					}else{
