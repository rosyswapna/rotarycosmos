...
$page = new Page;
	...
	$page->class_list = array("class_user.php", "class_userstatus.php", "class_clubposition.php","class_securityquestion.php", "class_pagination.php");
