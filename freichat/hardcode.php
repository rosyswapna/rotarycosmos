<?php
/* Data base details */
$dsn='mysql:host=localhost;dbname=cosm123_rotary'; //DSN
$db_user='cosm123_cosm123'; //DB username 
$db_pass='cosmos123'; //DB password 
$driver='Custom'; //Integration driver
$db_prefix=''; //prefix used for tables in database
$uid='51e7aadc3e602'; //Any random unique number
...
$admin_pswd='cosmos123'; //backend password 
