...
$page = new Page;
	...
	$page->title = "Rotary:  Meetings";	// page Title
	$page->page_name = 'meetings';		// page name for menu and other purpose
	...
	$page->class_list = array("class_meeting.php", "class_status.php", "class_pagination.php");
