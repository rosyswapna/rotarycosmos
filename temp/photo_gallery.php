...
$page = new Page;
	...
	$page->css_list = array("orbit-1.2.3.css");
	$page->js_list = array("jquery.min.js", "jquery.orbit-1.2.3.js");
	...
	$content_list[$index]['file_name']='inc_left_menu_events.php';
    $content_list[$index]['var_name']='left_menu';
    $index++;

	$content_list[$index]['file_name']='inc_p_gallery.php';
