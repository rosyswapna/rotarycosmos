...
$page = new Page;
	...
	$page->title = "Rotary:  News";	// page Title
	$page->page_name = 'news_all';		// page name for menu and other purpose
	...
	$page->class_list = array("class_news.php", "class_status.php", "class_pagination.php");
