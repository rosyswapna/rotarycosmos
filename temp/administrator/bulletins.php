...
$page = new Page;
	...
	$page->title = "Rotary: Administrator - Bulletins";	// page Title
	...
	$page->class_list = array("class_bulletin.php", "class_user.php", "class_pagination.php");
    ...
    $page->plugin_path = 'plugins/bulletin/'; 
    $page->plugin = 'list';
